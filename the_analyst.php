...
#displaying scores
		...
		$sql2 ="select mocks_users_ans.op_no as ua, mocks_a.op_no as a, attempt, mocks_a.sr_no as q, quest from mocks_users_ans, mocks_a, mocks_q where mocks_q.sr_no= mocks_users_ans.q_sr_no and  mocks_users_ans.q_sr_no=mocks_a.sr_no and uname='".$_SESSION["uname"]."' and test_no=".$test_no." order by mocks_users_ans.attempt,mocks_users_ans.q_sr_no";
		#echo "<BR>".$sql2."<BR>";
...
<?php					
				...
				$sql3 ="select * from mocks_o where sr_no=".$row2["q"]." order by op_no";
				#echo $sql3;
