...
#displaying scores
		...
		$sql2 ="select mocks_users_ans_chem.op_no as ua, mocks_a_chem.op_no as a, attempt, mocks_a_chem.sr_no as q, quest from mocks_users_ans_chem, mocks_a_chem, mocks_q_chem where mocks_q_chem.sr_no= mocks_users_ans_chem.q_sr_no and  mocks_users_ans_chem.q_sr_no=mocks_a_chem.sr_no and uname='".$_SESSION["uname"]."' and test_no=".$test_no." order by mocks_users_ans_chem.attempt,mocks_users_ans_chem.q_sr_no";
		#echo "<BR>".$sql2."<BR>";
...
<?php					
				...
				$sql3 ="select * from mocks_o_chem where sr_no=".$row2["q"]." order by op_no";
				#echo $sql3;
