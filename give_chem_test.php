...
if (mysqli_num_rows($result) > 0) 
{
	...
	if($row = mysqli_fetch_assoc($result))
	{
		...
		echo "<form action=give_chem_test.php method=get><input type=hidden name=tno value=".$_GET["tno"]."><input type=hidden name=qno value=".$qno.">";
		...
		$sql="delete from mocks_users_ans_chem where uname='".$_SESSION["uname"]."' and test_no=".$_GET["tno"]." and attempt=".$_SESSION["attempt"]." and ans_date_time=0000-00-00";
		#echo $sql."<BR>";
		if (mysqli_query($conn, $sql))
		{
