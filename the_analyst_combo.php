...
#displaying scores
		...
		$sql2 ="select mocks_users_ans_combo.op_no as ua, mocks_a_combo.op_no as a, attempt, mocks_a_combo.sr_no as q, quest from mocks_users_ans_combo, mocks_a_combo, mocks_q_combo where mocks_q_combo.sr_no= mocks_users_ans_combo.q_sr_no and  mocks_users_ans_combo.q_sr_no=mocks_a_combo.sr_no and uname='".$_SESSION["uname"]."' and test_no=".$test_no." order by mocks_users_ans_combo.attempt,mocks_users_ans_combo.q_sr_no";
		#echo "<BR>".$sql2."<BR>";
...
<?php					
				...
				$sql3 ="select * from mocks_o_combo where sr_no=".$row2["q"]." order by op_no";
				#echo $sql3;
